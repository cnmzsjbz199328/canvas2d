export const DEMO_SNAKE = [
"// --- ULTRA-LIGHT DATA RUNNER (DEMO MODE) ---",
...
"        // SAFE CONCATENATION: No backticks used here to avoid string escape hell",
...
"            ",
"            // Boundary check",
"            if (newHead.x >= 0 && newHead.x < state.cols && ",
...
"        ",
"        // Obstacles - simple flat rendering",
...
"                ctx.shadowBlur = 0;",
"            } else {",
"                // Every 4th segment gets subtle glow",
"                if (i % 4 === 0) {",
"                    ctx.shadowBlur = 8;",
"                    ctx.shadowColor = 'hsl(' + state.hue + ', 100%, 50%)';",
"                }",
